...
HD_PWD='/home_cds/std010/SoC_Design_2026_1/Soc_Design_2026_1/Source_Code/session4/1_mux/1_mux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log peri_mux_io.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source peri_mux_io.tcl
